...
public class LrcView extends View {
	...
	private int mLrcHeight; // lrc界面的高�?
	private int mRows;      // 多少�?
	private int mCurrentLine = 0; // 当前�?
	private int mOffsetY;   // y上的偏移
	private int mMaxScroll; // �?大滑动距�?=�?行歌词高�?+歌词间距

	private float mTextSize; // 字体
	private float mDividerHeight; // 行间�?
	
	private Rect mTextBounds;

	private Paint mNormalPaint; // 常规的字�?
	private Paint mCurrentPaint; // 当前歌词的大�?
